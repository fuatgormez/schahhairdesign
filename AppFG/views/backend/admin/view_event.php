<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>backend/admin/event/add" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
						...
						<tbody>
							...
							foreach ($event as $row) {
								...
								<tr>
									...
									<td>										
										<a href="<?php echo base_url(); ?>backend/admin/event/edit/<?php echo $row['event_id']; ?>" class="btn btn-primary btn-xs">Edit</a>
										<a href="<?php echo base_url(); ?>backend/admin/event/delete/<?php echo $row['event_id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure?');">Delete</a>  
									</td>
								</tr>
								<?php
							}

...
class Why_choose extends CI_Controller 
{
	function __construct() 
	{
        ...
        $this->load->model('backend/admin/Model_why_choose');
	...
	public function index()
	{
		...
		$this->load->view('backend/admin/view_why_choose',$data);
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
		    ...
		    if($valid == 1) 
		    {
				...
				redirect(base_url().'backend/admin/why_choose');
		    } 
		    else
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().'backend/admin/why_choose/add');
		    }
            
        } else {
            
            $this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_why_choose_add',$data);
			$this->load->view('backend/admin/view_footer');
        }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
		    ...
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().'backend/admin/why_choose/edit/'.$id);
		    }
           
		} else {
			$data['why_choose'] = $this->Model_why_choose->getData($id);
	       	$this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_why_choose_edit',$data);
			$this->load->view('backend/admin/view_footer');
		}

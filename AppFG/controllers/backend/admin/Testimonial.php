...
class Testimonial extends CI_Controller 
{
	function __construct() 
	{
        ...
        $this->load->model('backend/admin/Model_testimonial');
	...
	public function index()
	{
		...
		$this->load->view('backend/admin/view_testimonial',$data);
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
		    ...
		    if($valid == 1) 
		    {
				...
				redirect(base_url().'backend/admin/testimonial');
		    } 
		    else
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().'backend/admin/testimonial/add');
		    }
            
        } else {
            
            $this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_testimonial_add',$data);
			$this->load->view('backend/admin/view_footer');
        }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
		    ...
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().'backend/admin/testimonial/edit'.$id);
		    }
           
		} else {
			$data['testimonial'] = $this->Model_testimonial->get_testimonial($id);
	       	$this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_testimonial_edit',$data);
			$this->load->view('backend/admin/view_footer');
		}

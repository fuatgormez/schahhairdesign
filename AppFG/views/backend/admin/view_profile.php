			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
      				...
      				<div class="tab-pane active" id="tab_1">						
						<?php echo form_open(base_url().'backend/admin/profile/update',array('class' => 'form-horizontal')); ?>
      				...
      				<div class="tab-pane" id="tab_2">
						<?php echo form_open_multipart(base_url().'backend/admin/profile/update',array('class' => 'form-horizontal')); ?>
						<div class="box box-info">
							<div class="box-body">
								<div class="form-group">

<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>backend/admin/portfolio/add" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
							...
							foreach ($portfolio as $row) {
								...
								<tr>
									...
									<td>
										...
										<a href="<?php echo base_url(); ?>backend/admin/portfolio/delete/<?php echo $row['id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure?');">Delete</a>
									</td>
								</tr>

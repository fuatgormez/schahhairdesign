    ...
    <nav class="main-header navbar navbar-expand navbar-warning navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<?php echo base_url(); ?>backend/admin/dashboard" class="nav-link">ADMIN</a>
        </li>
      </ul>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo base_url('backend/shop/product_category');?>" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Product Category</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo base_url('backend/shop/product');?>" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Product</p>
                  </a>
                </li>

...
class Subscriber extends CI_Controller 
{
	function __construct() 
	{
        ...
        $this->load->model('backend/admin/Model_subscriber');
	...
	public function index()
	{
		...
		$this->load->view('backend/admin/view_subscriber',$data);
	...
	public function delete($id)
	{
    	...
    	if(!$tot) {
    		redirect(base_url().'backend/admin/subscriber');
        	exit;
    	}
    ...
    public function send_email()
	{
		...
		if(isset($_POST['form1'])) {
            ...
            if($valid == 1) 
            {
				...
				$this->session->set_flashdata('success',$success);
				redirect(base_url().'backend/admin/subscriber/send_email');
            }
            else
            {
		...
		{
			$this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_subscriber_email',$data);
			$this->load->view('backend/admin/view_footer');
		}
	}

            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab_footer">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Footer Map </label>
                            <div class="col-sm-6">
                                <textarea class="form-control" name="footer_map" style="height:70px;"><?php echo $setting['footer_map']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="tab-pane" id="tab_color">
                        ...
                        <div class="box box-info">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Default color: #0050aa</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="front_end_color" class="form-control jscolor" value="<?php echo $setting['front_end_color']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Default Background color: #0050aa</label>
                                    <div class="col-sm-4">

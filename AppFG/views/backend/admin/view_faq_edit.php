<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>backend/admin/faq" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open(base_url().'backend/admin/faq/edit/'.$faq['faq_id'],array('class' => 'form-horizontal')); ?>
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control" name="row" value="<?php echo $faq['row']; ?>">
							</div>
						</div>
						<div class="form-group">

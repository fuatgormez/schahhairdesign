...
class Team_member extends CI_Controller 
{
	function __construct() 
	{
        ...
        $this->load->model('backend/admin/Model_team_member');
	...
	public function index()
	{
		...
		$this->load->view('backend/admin/view_team_member',$data);
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
		    ...
		    if($valid == 1) 
		    {
		    	...
		    	redirect(base_url().'backend/admin/team_member');
		    } 
		    else
		    {
		    	$this->session->set_flashdata('error',$error);
		    	redirect(base_url().'backend/admin/team_member/add');
		    }
            
        } else {
            $this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_team_member_add',$data);
			$this->load->view('backend/admin/view_footer');
        }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
		    ...
		    {
		    	$this->session->set_flashdata('error',$error);
		    	redirect(base_url().'backend/admin/team_member/edit/'.$id);
		    }           
		} else {
			$data['team_member'] = $this->Model_team_member->get_team_member($id);
            $this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_team_member_edit',$data);
			$this->load->view('backend/admin/view_footer');
		}

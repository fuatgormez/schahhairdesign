...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url().'backend/shop/store/add_value',array('class' => 'form-horizontal')); ?>
				<div class="box box-info">
					<div class="box-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Land Name <span>*</span></label>
                            <div class="col-sm-6">
                                <input type="text" autocomplete="on" class="form-control" name="land_name" value="" placeholder="Deutschland" required>
                            </div>
                        </div>
                        <div class="form-group">
							<label for="" class="col-sm-2 control-label">Currency Code <span>*</span></label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="currency_code" value="" placeholder="EUR" required>
							</div>
						</div>
                        <div class="form-group">
							<label for="" class="col-sm-2 control-label">Currency Icon <span>*</span></label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="currency_icon" value="" placeholder="€" required>
							</div>
						</div>
                        <div class="form-group">
							<label for="" class="col-sm-2 control-label">Language Code <span>*</span></label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="lang_code" value="" placeholder="de" required>
							</div>
						</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="padding-top:5px">
                                <input type="file" name="lang_flag">(Only jpg, jpeg, gif, svg and png are allowed 400x260px)
                            </div>
                        </div>
                        <!-- Store Flag End -->

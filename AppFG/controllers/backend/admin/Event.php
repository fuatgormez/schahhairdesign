...
class Event extends CI_Controller 
{
	function __construct() 
	{
		...
		$this->load->model('backend/admin/Model_event');
	...
	public function index()
	{
		...
		$this->load->view('backend/admin/view_event',$data);
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
		    ...
		    if($valid == 1) 
		    {
				...
				redirect(base_url().'backend/admin/event');
		    } 
		    else
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().'backend/admin/event/add');
		    }
            
        } else {
            $this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_event_add',$data);
			$this->load->view('backend/admin/view_footer');
        }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
			...
			$data['event'] = $this->Model_event->getData($id);
            $this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_event_edit',$data);
			$this->load->view('backend/admin/view_footer');
		}

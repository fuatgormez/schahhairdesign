...
class Portfolio_category extends CI_Controller 
{
	function __construct() 
	{
		...
		$this->load->model('backend/admin/Model_portfolio_category');
	...
	public function index()
	{
		...
		$this->load->view('backend/admin/view_portfolio_category',$data);
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
		    ...
		    if($valid == 1) 
		    {
				...
				redirect(base_url().'backend/admin/portfolio_category');
		    }
		    else
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().'backend/admin/portfolio_category/add');
		    }
            
        } else {
            
            $this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_portfolio_category_add',$data);
			$this->load->view('backend/admin/view_footer');
        }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
			...
			$data['portfolio_category'] = $this->Model_portfolio_category->getData($id);
			$this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_portfolio_category_edit',$data);
			$this->load->view('backend/admin/view_footer');
		}

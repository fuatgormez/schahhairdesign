<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>backend/admin/why_choose" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url().'backend/admin/why_choose/edit/'.$why_choose['id'],array('class' => 'form-horizontal'));?>
				<div class="box box-info">
					<div class="box-body">						
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea class="form-control editor" name="content" style="height:140px;"><?php echo $why_choose['content']; ?></textarea>
							</div>
						</div>
						<div class="form-group">

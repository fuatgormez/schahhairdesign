...
class Faq extends CI_Controller 
{
	function __construct() 
	{
		...
		$this->load->model('backend/admin/Model_faq');
	...
	public function index()
	{
		...
		$this->load->view('backend/admin/view_faq',$data);
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
		    ...
		    {				
                ...
                redirect(base_url().'backend/admin/faq');
		    }
		    else
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().'backend/admin/faq/add');
		    }
            
        } else {
            $this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_faq_add',$data);
			$this->load->view('backend/admin/view_footer');
        }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
			...
			$data['faq'] = $this->Model_faq->getData($id);
	       	$this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_faq_edit',$data);
			$this->load->view('backend/admin/view_footer');
		}

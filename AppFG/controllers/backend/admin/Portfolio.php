...
class Portfolio extends CI_Controller 
{
	...
	public function index()
	{
		...
		$this->load->view('backend/admin/view_portfolio',$data);
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
		    ...
		    if($valid == 1) 
		    {
				...
				redirect(base_url().'backend/admin/portfolio');
		    } 
		    else
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().'backend/admin/portfolio/add');
		    }            
        } else {
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
		    ...
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().'backend/admin/portfolio/edit/'.$id);
		    }

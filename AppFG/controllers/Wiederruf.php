...
class Wiederruf extends CI_Controller {
...
//        $data['page_about'] = $this->Model_common->all_page_about();
        ...
        $data['page_wiederruf'] = $this->Model_common->all_page_wiederruf();
        ...
        $this->load->view('layout/'.$data['setting']['layout'].'/view_wiederruf',$data);

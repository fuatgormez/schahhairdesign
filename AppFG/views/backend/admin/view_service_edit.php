...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url().'backend/admin/service/edit/'.$service['id'],array('class' => 'form-horizontal'));?>
				<div class="box box-info">
					<div class="box-body">						
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Existing Photo 600x400</label>
							<div class="col-sm-9" style="padding-top:5px;">
								<img src="<?php echo base_url(); ?>public/uploads/service_photos/<?php echo $service['photo']; ?>" alt="Service Photo" style="width:200px;">
							</div>
						</div>
						<div class="form-group">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    foreach ($all_photos_by_id as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url(); ?>backend/admin/service/single-photo-delete/<?php echo $row['id']; ?>/<?php echo $service['id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure?');">Delete</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
                                <select name="service_status" class="form-control select2" style="width:auto;">
                                    <option value="Show" <?php if($service['status'] == 'Show') {echo 'selected';} ?>>Show</option>
                                    <option value="Hide" <?php if($service['status'] == 'Hide') {echo 'selected';} ?>>Hide</option>
                                </select>
							</div>

                            <label for="" class="col-sm-2 control-label">Row</label>
							<div class="col-sm-2">
                                <input type="text" class="form-control" name="service_row" value="<?php echo $service['row'];?>">
							</div>
						</div>
                        <div class="form-group">

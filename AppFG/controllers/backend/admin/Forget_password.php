...
class Forget_password extends CI_Controller 
{
    ...
    {
        parent::__construct();
        $this->load->model('backend/admin/Model_forget_password');
    ...
    public function index()
    {
        ...
        if(isset($_POST['form1'])) {
            ...
            if($valid == 1) {
                ...
                // Send Email
                $msg = '<p>To reset your password, please <a href="'.base_url().'backend/admin/reset-password/index/'.$_POST['email'].'/'.$token.'">click here</a> and enter a new password';
				...
				redirect(base_url().'backend/admin/forget_password');
            } else {
                $this->session->set_flashdata('error',$error);
				redirect(base_url().'backend/admin/forget_password');
            }            
        } else {
            $this->load->view('backend/admin/view_forget_password',$data);    
        }

...
<div class="banner-slider"
     style="background-image: url(<?php echo base_url(); ?>public/uploads/<?php echo $setting['banner_service']; ?>)">
    <div class="bg"></div>
                ...
                <div class="service-info">
                    <div class="single-ser-carousel owl-carousel">
                        <div class="event-photo-item">
                            <img src="<?php echo base_url(); ?>public/uploads/<?php echo $service['photo']; ?>"
                                 alt="Service Photo">
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="gallery-group">
                                <div class="gallery-photo"
                                     style="background-image: url(<?php echo base_url(); ?>/public/uploads/service_photos/<?php echo $row_service_photo['photo']; ?>)">
                                    <div class="gallery-bg"></div>
                                    <div class="gallery-table">
                                        <div class="gallery-icon">
                                            <a href="<?php echo base_url(); ?>/public/uploads/service_photos/<?php echo $row_service_photo['photo']; ?>"
                ...
                <div class="service-sidebar">
                    ...
                    <div class="service-sidebar-item headstyle">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" placeholder="<?php echo MESSAGE; ?>"

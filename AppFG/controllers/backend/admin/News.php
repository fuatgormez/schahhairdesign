...
class News extends CI_Controller 
{
	function __construct() 
	{
		...
		$this->load->model('backend/admin/Model_news');
	...
	public function index()
	{
		...
		$this->load->view('backend/admin/view_news',$data);
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
		    ...
		    if($valid == 1) 
		    {
				...
				redirect(base_url().'backend/admin/news');
		    } 
		    else
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().'backend/admin/news/add');
		    }
            
        } else {
            $data['all_category'] = $this->Model_news->get_category();
            $this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_news_add',$data);
			$this->load->view('backend/admin/view_footer');
        }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
			...
			$data['all_category'] = $this->Model_news->get_category();
            $this->load->view('backend/admin/view_header',$data);
			$this->load->view('backend/admin/view_news_edit',$data);
			$this->load->view('backend/admin/view_footer');
		}

...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php echo form_open_multipart(base_url() . 'backend/shop/email/edit/' .$email['sku'], array('class' => 'form-horizontal')); ?>
            <div class="box box-info">
                <div class="box-body">
                            ...
                            foreach ($all_store_value as $key => $row) : ?>
                                ...
                                <div class="tab-pane <?php echo $count == 0 ? 'active' : ''; ?>" id="<?php echo $row['store_value_id']; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" autocomplete="off" class="form-control" name="lang[<?php echo $row['store_value_id'] ?>][subject]" value="<?php echo @$email_lang[$key]['subject']; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control editor" name="lang[<?php echo $row['store_value_id'] ?>][message]" style="height:140px;"><?php echo @$email_lang[$key]['message']; ?></textarea>
                                        </div>
                                    </div>
                                    <!-- Message End -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control editor" name="lang[<?php echo $row['store_value_id'] ?>][mollie]" style="height:140px;"><?php echo @$email_lang[$key]['mollie']; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control editor" name="lang[<?php echo $row['store_value_id'] ?>][billing]" style="height:140px;"><?php echo @$email_lang[$key]['billing']; ?></textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="type" value="<?php echo @$email['type']; ?>">
                        </div>
                        
                        <label for="" class="col-sm-2 control-label">Step</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="step" value="<?php echo @$email['step']; ?>">
                        </div>
                    </div>
